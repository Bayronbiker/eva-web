...
import {
  ...
  Search, Bell, Settings, ChevronRight, Contact, HelpCircle, Phone, ExternalLink
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        >
          <h2 style={{ fontSize: '20px', fontWeight: '800', color: '#1A1C1E', textTransform: 'capitalize' }}>{seccionActiva}</h2>
        ...
        <main style={{ flex: 1, padding: '30px 40px', overflowY: 'auto' }}>
          {seccionActiva === 'dashboard' ? (
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '20px', marginBottom: '30px' }}>
                ...
                >
                  <div style={{ zIndex: 10 }}>
                    ...
                    <h3 style={{ fontSize: '42px', fontWeight: '900', letterSpacing: '-2px' }}>${resumen.saldo?.toLocaleString()}</h3>
                  </div>
                  <div style={{ zIndex: 10, display: 'flex', gap: '10px', marginTop: '20px' }}>
                    <button
                      type="button"
                      onClick={() => { setSeccionActiva('facturas'); setFacturaSeleccionada(null); setVistaFactura('crear'); }}
                      style={{ flex: 1, padding: '12px', backgroundColor: primaryGreen, color: '#fff', border: 'none', borderRadius: '12px', fontWeight: '800', fontSize: '11px', cursor: 'pointer' }}
                    >
                      CREAR FACTURA
                    </button>
                    <button
                      ...
                      style={{ flex: 1, padding: '12px', backgroundColor: 'rgba(255,255,255,0.1)', color: '#fff', border: 'none', borderRadius: '12px', fontWeight: '800', fontSize: '11px', cursor: 'pointer' }}
                    >
                      CLIENTE
                    </button>
                  </div>
                ...
                <div style={{ gridColumn: 'span 7', position: 'relative', borderRadius: '32px', overflow: 'hidden', height: '280px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                  {banners.map((b, i) => (
                    <div
                      key={b.id}
                      style={{
                    ...
                    >
                      <h2 style={{ fontSize: '32px', fontWeight: '900', color: '#fff', marginBottom: '5px' }}>{b.title}</h2>
                      <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.8)', maxWidth: '300px' }}>{b.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '32px', border: '1px solid #F1F5F9' }}>
                ...
                {movimientos.length > 0 ? (
                  movimientos.slice(0, 4).map((m, i) => (
                    <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '15px 20px', backgroundColor: '#F9FAFB', borderRadius: '20px', marginBottom: '10px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                        <div style={{ padding: '10px', backgroundColor: m.tipo === 'ingreso' ? '#E8F5E9' : '#FFEBEE', borderRadius: '12px', color: m.tipo === 'ingreso' ? '#2E7D32' : '#C62828' }}>
                          {m.tipo === 'ingreso' ? <ArrowUpCircle size={18} /> : <ArrowDownCircle size={18} />}
                        </div>
                        <span style={{ fontSize: '14px', fontWeight: '700', color: '#1A1C1E' }}>{m.descripcion}</span>
                      </div>
                      <span style={{ fontSize: '15px', fontWeight: '800', color: m.tipo === 'ingreso' ? '#2E7D32' : '#1A1C1E' }}>
              ...
              <CrearFactura
                ...
                onSave={async (d) => {
                  try {
                    ...
                    // ✅ clienteId es opcional — la app no siempre lo tiene
                    ...
                    // ✅ Recalcular valores desde los campos de calculos que vienen en d
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              <div style={{ background: '#fff', borderRadius: '32px', padding: '50px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '32px', fontWeight: '900', color: '#1A1C1E', marginBottom: '10px' }}>Jhon Zamudio Santafe</h2>
                <p style={{ fontSize: '18px', color: primaryGreen, fontWeight: '700', marginBottom: '30px', textTransform: 'uppercase', letterSpacing: '1px' }}>Diseñador y Full Stack Developer</p>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '15px', maxWidth: '400px', margin: '0 auto 40px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '15px', padding: '20px', background: '#F9FAFB', borderRadius: '20px', border: '1px solid #F1F5F9' }}>
                    <div style={{ padding: '10px', background: '#fff', borderRadius: '12px', color: primaryGreen, boxShadow: '0 4px 10px rgba(0,0,0,0.05)' }}><Phone size={20} /></div>
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto' }}>
              <div style={{ marginBottom: '40px', textAlign: 'center' }}>
                <h2 style={{ fontSize: '32px', fontWeight: '900', color: '#1A1C1E' }}>Centro de Ayuda</h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', marginBottom: '40px' }}>
                <div style={{ background: '#fff', padding: '25px', borderRadius: '24px', border: '1px solid #F1F5F9', display: 'flex', alignItems: 'center', gap: '20px', cursor: 'pointer' }}>
                  <div style={{ padding: '12px', background: '#E8F5E9', borderRadius: '16px', color: primaryGreen }}><Search size={24} /></div>
                ...
                <div style={{ background: '#fff', padding: '25px', borderRadius: '24px', border: '1px solid #F1F5F9', display: 'flex', alignItems: 'center', gap: '20px', cursor: 'pointer' }}>
                  <div style={{ padding: '12px', background: '#E3F2FD', borderRadius: '16px', color: '#1E88E5' }}><Bell size={24} /></div>
